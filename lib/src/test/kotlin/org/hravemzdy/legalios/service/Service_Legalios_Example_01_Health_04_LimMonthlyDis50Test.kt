...
class Service_Legalios_Example_01_Health_04_LimMonthlyDis50Test  : Spek({
    val testList = listOf(
    ...
    logTestIntExamples("01_Health_04_LimMonthlyDis50.txt", testList)
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        assertEquals(tt.expected, props?.limMonthlyDis50)
                    }
                }
            }
        }
