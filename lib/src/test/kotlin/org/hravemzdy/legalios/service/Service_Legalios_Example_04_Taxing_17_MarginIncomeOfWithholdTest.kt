...
class Service_Legalios_Example_04_Taxing_17_MarginIncomeOfWithholdTest  : Spek({
    val testList = listOf(
        TestIntScenario("2010", listOf(
            TestIntParams( "2010-1", 2010, 1, 2010, 1, 5000 ),
            TestIntParams( "2010-2", 2010, 2, 2010, 2, 5000 ),
            TestIntParams( "2010-3", 2010, 3, 2010, 3, 5000 ),
            TestIntParams( "2010-4", 2010, 4, 2010, 4, 5000 ),
            TestIntParams( "2010-5", 2010, 5, 2010, 5, 5000 ),
            TestIntParams( "2010-6", 2010, 6, 2010, 6, 5000 ),
            TestIntParams( "2010-7", 2010, 7, 2010, 7, 5000 ),
            TestIntParams( "2010-8", 2010, 8, 2010, 8, 5000 ),
            TestIntParams( "2010-9", 2010, 9, 2010, 9, 5000 ),
            TestIntParams( "2010-10", 2010, 10, 2010, 10, 5000 ),
            TestIntParams( "2010-11", 2010, 11, 2010, 11, 5000 ),
            TestIntParams( "2010-12", 2010, 12, 2010, 12, 5000 ),
        )),
        TestIntScenario("2011", listOf(
            TestIntParams( "2011-1", 2011, 1, 2011, 1, 5000 ),
            TestIntParams( "2011-2", 2011, 2, 2011, 2, 5000 ),
            TestIntParams( "2011-3", 2011, 3, 2011, 3, 5000 ),
            TestIntParams( "2011-4", 2011, 4, 2011, 4, 5000 ),
            TestIntParams( "2011-5", 2011, 5, 2011, 5, 5000 ),
            TestIntParams( "2011-6", 2011, 6, 2011, 6, 5000 ),
            TestIntParams( "2011-7", 2011, 7, 2011, 7, 5000 ),
            TestIntParams( "2011-8", 2011, 8, 2011, 8, 5000 ),
            TestIntParams( "2011-9", 2011, 9, 2011, 9, 5000 ),
            TestIntParams( "2011-10", 2011, 10, 2011, 10, 5000 ),
            TestIntParams( "2011-11", 2011, 11, 2011, 11, 5000 ),
            TestIntParams( "2011-12", 2011, 12, 2011, 12, 5000 ),
        )),
        TestIntScenario("2012", listOf(
            TestIntParams( "2012-1", 2012, 1, 2012, 1, 5000 ),
            TestIntParams( "2012-2", 2012, 2, 2012, 2, 5000 ),
            TestIntParams( "2012-3", 2012, 3, 2012, 3, 5000 ),
            TestIntParams( "2012-4", 2012, 4, 2012, 4, 5000 ),
            TestIntParams( "2012-5", 2012, 5, 2012, 5, 5000 ),
            TestIntParams( "2012-6", 2012, 6, 2012, 6, 5000 ),
            TestIntParams( "2012-7", 2012, 7, 2012, 7, 5000 ),
            TestIntParams( "2012-8", 2012, 8, 2012, 8, 5000 ),
            TestIntParams( "2012-9", 2012, 9, 2012, 9, 5000 ),
            TestIntParams( "2012-10", 2012, 10, 2012, 10, 5000 ),
            TestIntParams( "2012-11", 2012, 11, 2012, 11, 5000 ),
            TestIntParams( "2012-12", 2012, 12, 2012, 12, 5000 ),
        )),
        TestIntScenario("2013", listOf(
            TestIntParams( "2013-1", 2013, 1, 2013, 1, 5000 ),
            TestIntParams( "2013-2", 2013, 2, 2013, 2, 5000 ),
            TestIntParams( "2013-3", 2013, 3, 2013, 3, 5000 ),
            TestIntParams( "2013-4", 2013, 4, 2013, 4, 5000 ),
            TestIntParams( "2013-5", 2013, 5, 2013, 5, 5000 ),
            TestIntParams( "2013-6", 2013, 6, 2013, 6, 5000 ),
            TestIntParams( "2013-7", 2013, 7, 2013, 7, 5000 ),
            TestIntParams( "2013-8", 2013, 8, 2013, 8, 5000 ),
            TestIntParams( "2013-9", 2013, 9, 2013, 9, 5000 ),
            TestIntParams( "2013-10", 2013, 10, 2013, 10, 5000 ),
            TestIntParams( "2013-11", 2013, 11, 2013, 11, 5000 ),
            TestIntParams( "2013-12", 2013, 12, 2013, 12, 5000 ),
        )),
    ...
    logTestIntExamples("04_Taxing_17_MarginIncomeOfWithhold.txt", testList)
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        assertEquals(tt.expected, props?.marginIncomeOfWithhold)
                    }
                }
            }
        }
