...
class Service_Legalios_Example_03_Social_06_FactorEmployeeReduceTest  : Spek({
    val testList = listOf(
    ...
    logTestDecExamples("03_Social_06_FactorEmployeeReduce.txt", testList)
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        ...
                        assertEquals(expDecimal, props?.factorEmployeeReduce)
                    }
                }
            }
        }
