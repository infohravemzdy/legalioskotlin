...
object HistoryConstHealth2022 {
    ...
    const val MIN_MONTHLY_BASIS:Int = HistoryConstSalary2022.MIN_MONTHLY_WAGE
    const val MAX_ANNUALS_BASIS:Int = HistoryConstHealth2021.MAX_ANNUALS_BASIS
    const val LIM_MONTHLY_STATE:Int = HistoryConstHealth2021.LIM_MONTHLY_STATE
    const val LIM_MONTHLY_DIS50:Int = 14570
    ...
    const val MARGIN_INCOME_EMP:Int = HistoryConstHealth2021.MARGIN_INCOME_EMP
    const val MARGIN_INCOME_AGR:Int = HistoryConstHealth2021.MARGIN_INCOME_AGR
}
