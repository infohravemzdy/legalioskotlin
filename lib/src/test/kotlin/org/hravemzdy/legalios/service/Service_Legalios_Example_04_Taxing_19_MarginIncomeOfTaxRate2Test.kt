...
class Service_Legalios_Example_04_Taxing_19_MarginIncomeOfTaxRate2Test : Spek({
    val testList = listOf(
        ...
        TestIntScenario("2021", listOf(
            TestIntParams( "2021-1", 2021, 1, 2021, 1, 141764 ),
            TestIntParams( "2021-2", 2021, 2, 2021, 2, 141764 ),
            TestIntParams( "2021-3", 2021, 3, 2021, 3, 141764 ),
            TestIntParams( "2021-4", 2021, 4, 2021, 4, 141764 ),
            TestIntParams( "2021-5", 2021, 5, 2021, 5, 141764 ),
            TestIntParams( "2021-6", 2021, 6, 2021, 6, 141764 ),
            TestIntParams( "2021-7", 2021, 7, 2021, 7, 141764 ),
            TestIntParams( "2021-8", 2021, 8, 2021, 8, 141764 ),
            TestIntParams( "2021-9", 2021, 9, 2021, 9, 141764 ),
            TestIntParams( "2021-10", 2021, 10, 2021, 10, 141764 ),
            TestIntParams( "2021-11", 2021, 11, 2021, 11, 141764 ),
            TestIntParams( "2021-12", 2021, 12, 2021, 12, 141764 ),
        )),
        TestIntScenario("2022", listOf(
            TestIntParams( "2022-1", 2022, 1, 2022, 1, 155644 ),
            TestIntParams( "2022-2", 2022, 2, 2022, 2, 155644 ),
            TestIntParams( "2022-3", 2022, 3, 2022, 3, 155644 ),
            TestIntParams( "2022-4", 2022, 4, 2022, 4, 155644 ),
            TestIntParams( "2022-5", 2022, 5, 2022, 5, 155644 ),
            TestIntParams( "2022-6", 2022, 6, 2022, 6, 155644 ),
            TestIntParams( "2022-7", 2022, 7, 2022, 7, 155644 ),
            TestIntParams( "2022-8", 2022, 8, 2022, 8, 155644 ),
            TestIntParams( "2022-9", 2022, 9, 2022, 9, 155644 ),
            TestIntParams( "2022-10", 2022, 10, 2022, 10, 155644 ),
            TestIntParams( "2022-11", 2022, 11, 2022, 11, 155644 ),
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        assertEquals(tt.expected, props?.marginIncomeOfTaxRate2)
                    }
                }
            }
        }
