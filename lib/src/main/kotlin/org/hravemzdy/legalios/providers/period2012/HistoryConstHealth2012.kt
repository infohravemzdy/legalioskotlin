...
object HistoryConstHealth2012 {
    ...
    const val MIN_MONTHLY_BASIS:Int = HistoryConstSalary2012.MIN_MONTHLY_WAGE
    const val MAX_ANNUALS_BASIS:Int = 1809864
    const val LIM_MONTHLY_STATE:Int = HistoryConstHealth2011.LIM_MONTHLY_STATE
    const val LIM_MONTHLY_DIS50:Int = HistoryConstHealth2011.LIM_MONTHLY_DIS50
