...
class Service_Legalios_Example_04_Taxing_20_MarginIncomeOfWthEmpTest  : Spek({
    val testList = listOf(
        ...
        TestIntScenario("2019", listOf(
            TestIntParams( "2019-1", 2019, 1, 2019, 1, 2500 ),
            TestIntParams( "2019-2", 2019, 2, 2019, 2, 2500 ),
            TestIntParams( "2019-3", 2019, 3, 2019, 3, 2500 ),
            TestIntParams( "2019-4", 2019, 4, 2019, 4, 2500 ),
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        assertEquals(tt.expected, props?.marginIncomeOfWthEmp)
                    }
                }
            }
        }
