...
object HistoryConstHealth2021 {
    ...
    const val MIN_MONTHLY_BASIS:Int = HistoryConstSalary2021.MIN_MONTHLY_WAGE
    const val MAX_ANNUALS_BASIS:Int = HistoryConstHealth2020.MAX_ANNUALS_BASIS
    const val LIM_MONTHLY_STATE:Int = HistoryConstHealth2020.LIM_MONTHLY_STATE
    const val LIM_MONTHLY_DIS50:Int = 13088
    ...
    const val MARGIN_INCOME_EMP:Int = 3500
    const val MARGIN_INCOME_AGR:Int = HistoryConstHealth2020.MARGIN_INCOME_AGR
}
