...
class Service_Legalios_Example_03_Social_03_FactorEmployerHigherTest  : Spek({
    val testList = listOf(
        ...
        TestDecScenario("2011", listOf(
            TestDecParams( "2011-1", 2011, 1, 2011, 1, 26.0 ),
            TestDecParams( "2011-2", 2011, 2, 2011, 2, 26.0 ),
            TestDecParams( "2011-3", 2011, 3, 2011, 3, 26.0 ),
            TestDecParams( "2011-4", 2011, 4, 2011, 4, 26.0 ),
            TestDecParams( "2011-5", 2011, 5, 2011, 5, 26.0 ),
            TestDecParams( "2011-6", 2011, 6, 2011, 6, 26.0 ),
            TestDecParams( "2011-7", 2011, 7, 2011, 7, 26.0 ),
            TestDecParams( "2011-8", 2011, 8, 2011, 8, 26.0 ),
            TestDecParams( "2011-9", 2011, 9, 2011, 9, 26.0 ),
            TestDecParams( "2011-10", 2011, 10, 2011, 10, 26.0 ),
            TestDecParams( "2011-11", 2011, 11, 2011, 11, 26.0 ),
            TestDecParams( "2011-12", 2011, 12, 2011, 12, 26.0 ),
        )),
        TestDecScenario("2012", listOf(
            TestDecParams( "2012-1", 2012, 1, 2012, 1, 26.0 ),
            TestDecParams( "2012-2", 2012, 2, 2012, 2, 26.0 ),
            TestDecParams( "2012-3", 2012, 3, 2012, 3, 26.0 ),
            TestDecParams( "2012-4", 2012, 4, 2012, 4, 26.0 ),
            TestDecParams( "2012-5", 2012, 5, 2012, 5, 26.0 ),
            TestDecParams( "2012-6", 2012, 6, 2012, 6, 26.0 ),
            TestDecParams( "2012-7", 2012, 7, 2012, 7, 26.0 ),
            TestDecParams( "2012-8", 2012, 8, 2012, 8, 26.0 ),
            TestDecParams( "2012-9", 2012, 9, 2012, 9, 26.0 ),
            TestDecParams( "2012-10", 2012, 10, 2012, 10, 26.0 ),
            TestDecParams( "2012-11", 2012, 11, 2012, 11, 26.0 ),
            TestDecParams( "2012-12", 2012, 12, 2012, 12, 26.0 ),
        )),
        TestDecScenario("2013", listOf(
            TestDecParams( "2013-1", 2013, 1, 2013, 1, 26.0 ),
            TestDecParams( "2013-2", 2013, 2, 2013, 2, 26.0 ),
            TestDecParams( "2013-3", 2013, 3, 2013, 3, 26.0 ),
            TestDecParams( "2013-4", 2013, 4, 2013, 4, 26.0 ),
            TestDecParams( "2013-5", 2013, 5, 2013, 5, 26.0 ),
            TestDecParams( "2013-6", 2013, 6, 2013, 6, 26.0 ),
            TestDecParams( "2013-7", 2013, 7, 2013, 7, 26.0 ),
            TestDecParams( "2013-8", 2013, 8, 2013, 8, 26.0 ),
            TestDecParams( "2013-9", 2013, 9, 2013, 9, 26.0 ),
            TestDecParams( "2013-10", 2013, 10, 2013, 10, 26.0 ),
            TestDecParams( "2013-11", 2013, 11, 2013, 11, 26.0 ),
            TestDecParams( "2013-12", 2013, 12, 2013, 12, 26.0 ),
        )),
        TestDecScenario("2014", listOf(
            TestDecParams( "2014-1", 2014, 1, 2014, 1, 26.0 ),
            TestDecParams( "2014-2", 2014, 2, 2014, 2, 26.0 ),
            TestDecParams( "2014-3", 2014, 3, 2014, 3, 26.0 ),
            TestDecParams( "2014-4", 2014, 4, 2014, 4, 26.0 ),
            TestDecParams( "2014-5", 2014, 5, 2014, 5, 26.0 ),
            TestDecParams( "2014-6", 2014, 6, 2014, 6, 26.0 ),
            TestDecParams( "2014-7", 2014, 7, 2014, 7, 26.0 ),
            TestDecParams( "2014-8", 2014, 8, 2014, 8, 26.0 ),
            TestDecParams( "2014-9", 2014, 9, 2014, 9, 26.0 ),
            TestDecParams( "2014-10", 2014, 10, 2014, 10, 26.0 ),
            TestDecParams( "2014-11", 2014, 11, 2014, 11, 26.0 ),
            TestDecParams( "2014-12", 2014, 12, 2014, 12, 26.0 ),
        )),
    ...
    logTestDecExamples("03_Social_03_FactorEmployerHigher.txt", testList)
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        ...
                        assertEquals(expDecimal, props?.factorEmployerHigher)
                    }
                }
            }
        }
