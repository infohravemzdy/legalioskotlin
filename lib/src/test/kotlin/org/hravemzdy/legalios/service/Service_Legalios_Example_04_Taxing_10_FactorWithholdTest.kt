...
class Service_Legalios_Example_04_Taxing_10_FactorWithholdTest  : Spek({
    val testList = listOf(
    ...
    logTestDecExamples("04_Taxing_10_FactorWithhold.txt", testList)
            ...
            tx.tests.forEach { tt ->
                context("period ${tt.title}") {
                    ...
                    it("GetProps should return value = ${tt.expected}") {
                        ...
                        assertEquals(expDecimal, props?.factorWithhold)
                    }
                }
            }
        }
